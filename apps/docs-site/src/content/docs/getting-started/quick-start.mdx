...
2. `TelInput` parses the input with [libphonenumber-js](https://gitlab.com/catamphetamine/libphonenumber-js), auto-detects the country from the dial code, and formats the display value.
