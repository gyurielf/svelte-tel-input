<script lang="ts">
	...
	import AdvancedPhoneInput from '../components/examples/AdvancedPhoneInput.svelte';
	import ApiTestPanel from '../components/examples/ApiTestPanel.svelte';
	import PayloadBlock from '../components/utils/PayloadBlock.svelte';
