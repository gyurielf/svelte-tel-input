<script lang="ts">
	import { theme } from '../stores/DevExampleStores';
	...
	const isDarkModeEnabled = $derived($theme);
</script>
...
<button
	class={classes +
        ...
        ml-(--theme-switch-ml,0) cursor-pointer transition-opacity duration-200 hover:outline-none`}
	role="switch"
