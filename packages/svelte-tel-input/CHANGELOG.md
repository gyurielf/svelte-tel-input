...
- Performance and developer-experience improvements: ([#274](https://github.com/gyurielf/svelte-tel-input/pull/274))
...
- breaking: refactor ([#258](https://github.com/gyurielf/svelte-tel-input/pull/258))
...
- chore: test job & cleanup ([#258](https://github.com/gyurielf/svelte-tel-input/pull/258))
...
- fix: no more brackets and hyphens in the parsed number ([#258](https://github.com/gyurielf/svelte-tel-input/pull/258))
